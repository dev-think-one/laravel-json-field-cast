...
class ArrayMetaTextTest extends TestCase
{
    protected User $user;
    ...
    public function user_cast_field_to_object_if_null()
    {
        ...
        $this->assertInstanceOf(\JsonFieldCast\Json\ArrayOfJsonObjectsField::class, $this->user->array_text_meta);
        /** @var \JsonFieldCast\Json\ArrayOfJsonObjectsField $meta */
        $meta = $this->user->array_text_meta;
    ...
    {
        $this->assertNotNull($this->user2->getRawOriginal('array_text_meta'));
        $this->assertInstanceOf(\JsonFieldCast\Json\ArrayOfJsonObjectsField::class, $this->user2->array_text_meta);
        /** @var \JsonFieldCast\Json\ArrayOfJsonObjectsField $meta */
        $meta = $this->user2->array_text_meta;
